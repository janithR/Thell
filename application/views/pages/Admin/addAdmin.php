                ...
                <form action="#" id="form" class="form-horizontal" data-parsley-validate>
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="username" placeholder="Username" class="form-control" type="text" data-parsley-required-message="username is required" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Email</label>
                            <div class="col-md-9">
                                <input name="email" placeholder="Email" class="form-control" type="text" data-parsley-type="email" data-parsley-required-message="email is required" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Password</label>
                            <div class="col-md-9">
                                <input type="text" name="password" placeholder="Password" class="form-control" data-parsley-required-message="password is required" required="">
                            </div>
                        </div>
                    </div>
                </form>
