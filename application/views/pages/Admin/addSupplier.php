...
<div class = "row">
    <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add New Supplier</button>
    <br />
    <br />
...
<script type="text/javascript">
    ...
    function add_person()
    {
        ...
        $('.modal-title').text('Add New Supplier'); // Set Title to Bootstrap modal title
    }

    function edit_person(s_id)
    {
        save_method = 'update';
        $('#form')[0].reset(); // reset form on modals
        ...
        $.ajax({
            url : "<?php echo site_url('Supplier/ajax_edit/')?>/" + s_id,
            type: "GET",
            dataType: "JSON",
    ...
    function delete_person(s_id)
    {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    url : "<?php echo site_url('Supplier/ajax_delete')?>/"+s_id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
    ...
    function view_person(s_id)
    {
        $.ajax({
            url : "<?php echo site_url('Supplier/list_by_id')?>/" + s_id,
            type: "GET",
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="s_name" placeholder="Supplier Name" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Supplier Registration No.</label>
                            <div class="col-md-9">
                                <input name="reg_no" placeholder="Supplier Registration Number" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
