...
<form class="form-horizontal" id="dataCryo" method="post" enctype="multipart/form-data">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <label for="" class="col-sm-2 control-label">Unit Price : </label>

            <div class="col-sm-6">
                <h5 class="col-sm-6 "><?php echo $data->unit_price; ?></h5>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#butangBack').unbind('click').click(function () {
            $.ajax({
                url : "<?php echo base_url();?>Supplier_dashboard/Price_List",
