    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a  style="color: forestgreen; font-size: 200%; font-weight: bolder; display: inline; padding-right: 40px" href="" ><img src='<?php echo base_url();?>assets/images/gs.png' width="35px" height="35px">THEL.LK</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a style="font-size: 20px; color: forestgreen" href="">log out&nbsp<span class="glyphicon glyphicon-log-out"></span></a></li>
                </ul>
