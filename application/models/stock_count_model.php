...
class Stock_count_model extends CI_Model{
    ...
    var $table = 'stock_count';
    var $column = array('fuel_type','height','volume','date','time');
    var $order = array('stock_id' => 'desc');
    ...
    public function delete_by_id($stock_id)
    {
        $this->db->where('stock_id', $stock_id);
        $this->db->delete($this->table);
    }

    public function get_by_id_view($stock_id)
    {
        $this->db->from($this->table);
        $this->db->where('stock_id',$stock_id);
        $query = $this->db->get();
